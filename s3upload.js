(function() {
  window.S3Upload = (function() {
    ...
    S3Upload.prototype.executeOnSignedUrl = function(file, callback) {
      ...
      type = (file != null ? file.type : void 0) || "application/octet-stream";
      xhr = new XMLHttpRequest();
      xhr.open('GET', this.s3_sign_put_url + '?s3_object_type=' + type + '&s3_object_name=' + encodeURIComponent(this.s3_object_name), true);
